# Rewrite web_search.py to use GLM API for search (since it has web access)
lines = [
    '# -*- coding: utf-8 -*-',
    '',
    'import asyncio',
...
open(r'D:\桌面\quant_backtest\automation\web_search.py', 'w', encoding='utf-8').write(content)
print('OK: web_search.py rewritten for GLM-based search')
